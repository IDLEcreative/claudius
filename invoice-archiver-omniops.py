#!/usr/bin/env python3
"""
Invoice Archiver for OmniOps (hello@omniops.co.uk)

Downloads PDF/image attachments from receipt emails and uploads them
to the appropriate quarterly folder on OmniOps Google Drive.

Folder structure on Drive:
  VAT INVOICES & RECEIPTS/
    └── 2026/
         └── Invoices and receipts 01.12.2025 – 28.02.2026
...
# Config - OMNIOPS
CREDENTIALS_FILE = "/opt/claudius/.google_workspace_mcp/credentials/hello@omniops.co.uk.json"
STATE_FILE = "/opt/claudius/invoice_archiver_omniops_state.json"
USER_EMAIL = "hello@omniops.co.uk"

TELEGRAM_BOT_TOKEN = "8387428119:AAEGEeSCBSdw7y4SSv9FV_7rDzjDyu-SNmQ"
TELEGRAM_CHAT_ID = "7070679785"

# Drive folder IDs - OMNIOPS
VAT_FOLDER_ID = "1niH7OOT4Z_Svl1HNnqWfFoY8q11PCPuE"  # VAT INVOICES & RECEIPTS on OmniOps Drive
