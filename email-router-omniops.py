...
# OMNIOPS - SaaS product account
CREDENTIALS_FILE = "/opt/claudius/.google_workspace_mcp/credentials/hello@omniops.co.uk.json"
STATE_FILE = "/opt/claudius/email_router_omniops_state.json"
LEARNED_SENDERS_FILE = "/opt/claudius/email_learned_senders_omniops.json"
...
# Drive folder for invoices - OMNIOPS
VAT_FOLDER_ID = "1niH7OOT4Z_Svl1HNnqWfFoY8q11PCPuE"
